            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    ...
                    >
                        ...
                        >
                            <PrimaryButton :disabled="form.processing">Match</PrimaryButton>
                            <div v-for="ld in loan_data" :key="ld.sku" class="w-full">
                                <h1 class="text-base">SKU: <span class="font-bold">{{ ld.sku }}</span></h1>
                                <p class="text-sm">Name: <span class="font-bold">{{ ld.name }}</span></p>
                                <p class="text-sm">TCP: <span class="font-bold">₱ {{ formatNumber(ld.total_contract_price) }}</span></p>
                            </div>
                        </div>
                        ...
                        >
                            <InputLabel for="date_of_birth" value="Birth Date" />
                            <TextInput
                                id="date_of_birth"
                                type="date"
